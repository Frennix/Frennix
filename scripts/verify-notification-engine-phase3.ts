...
function testClientWebPush() {
  ...
  assertIncludes(read("components/WebPushPermissionPrompt.tsx"), "Enable Push Notifications", "permission prompt");
  assertIncludes(read("components/WebPushEnableCard.tsx"), "Enable Push Notifications", "enable card");
