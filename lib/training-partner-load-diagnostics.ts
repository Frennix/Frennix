...
/**
 * TEMP investigation flag — when true, any signed-in user sees load diagnostics.
 * Keep false outside active investigations.
 */
export const TRAINING_PARTNER_LOAD_DIAGNOSTICS_PROD_DEBUG = false;
