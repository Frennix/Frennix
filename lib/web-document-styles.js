...
const frennixWebDocumentCss = `
  ...
  /* Fullscreen lightbox — single-layer inline player; no native fullscreen/AirPlay entry. */
  video.fullscreen-video-slide::-webkit-media-controls-fullscreen-button {
    display: none !important;
  }
  video.fullscreen-video-slide::-webkit-media-controls-wireless-playback-picker-button {
    display: none !important;
  }
  ...
  video.fullscreen-video-slide.fullscreen-controls-hidden::-webkit-media-controls {
    opacity: 0 !important;
    pointer-events: none !important;
    transition: opacity 0.35s ease;
  }
  video.fullscreen-video-slide.fullscreen-controls-hidden::-webkit-media-controls-panel {
    opacity: 0 !important;
    pointer-events: none !important;
    transition: opacity 0.35s ease;
  }
  video.fullscreen-video-slide.fullscreen-controls-hidden::-webkit-media-controls-enclosure {
    opacity: 0 !important;
    pointer-events: none !important;
    transition: opacity 0.35s ease;
  }
  video.fullscreen-video-slide.fullscreen-controls-hidden::-webkit-media-controls-overlay-play-button {
    opacity: 0 !important;
    pointer-events: none !important;
    transition: opacity 0.35s ease;
  }
  video.fullscreen-video-slide.fullscreen-controls-visible::-webkit-media-controls {
    opacity: 1 !important;
    pointer-events: auto !important;
    transition: opacity 0.2s ease;
  }
  video.fullscreen-video-slide.fullscreen-controls-visible::-webkit-media-controls-panel {
    opacity: 1 !important;
    pointer-events: auto !important;
    transition: opacity 0.2s ease;
  }
  video.fullscreen-video-slide.fullscreen-controls-visible::-webkit-media-controls-enclosure {
    opacity: 1 !important;
    pointer-events: auto !important;
    transition: opacity 0.2s ease;
  }
  video.fullscreen-video-slide.fullscreen-controls-visible::-webkit-media-controls-overlay-play-button {
    opacity: 1 !important;
    pointer-events: auto !important;
    transition: opacity 0.2s ease;
  }
