...
const frennixWebDocumentCss = `
  ...
  textarea[data-frennix-comment-input="true"]:not([data-video-comment-input="true"]) {
    overflow-x: hidden !important;
  ...
  [data-video-comment-composer="true"] {
    ...
    bottom: calc(env(safe-area-inset-bottom, 0px) + var(--safari-toolbar-clearance, 72px)) !important;
  }
  [data-video-comment-composer="true"][data-video-composer-keyboard-open="true"] {
    bottom: calc(var(--keyboard-offset, 0px) + var(--safari-keyboard-clearance, 90px)) !important;
    padding-bottom: 10px !important;
  }
  [data-video-comment-composer="true"][data-video-composer-keyboard-open="false"][data-video-composer-standalone="true"] {
    bottom: env(safe-area-inset-bottom, 0px) !important;
    padding-bottom: calc(10px + env(safe-area-inset-bottom, 0px)) !important;
  }
  [data-video-comment-composer="true"] [data-frennix-comment-composer-row="true"] {
    box-sizing: border-box !important;
    display: flex !important;
  ...
  [data-video-comment-composer="true"] [data-frennix-comment-composer-field="true"] {
    box-sizing: border-box !important;
    flex: 1 1 auto !important;
    min-width: 0 !important;
  ...
  [data-video-comment-composer="true"] [data-frennix-comment-input-wrap="true"] {
    box-sizing: border-box !important;
    width: 100% !important;
    min-width: 0 !important;
  ...
  [data-video-comment-composer="true"] textarea[data-video-comment-input="true"] {
    appearance: none !important;
    -webkit-appearance: none !important;
    box-sizing: border-box !important;
    display: block !important;
  ...
  [data-video-comment-composer="true"] textarea[data-video-comment-input="true"]::placeholder {
    color: #9a9aa1 !important;
    opacity: 1 !important;
  }
  [data-video-comment-composer="true"] [data-frennix-comment-composer-row="true"] [role="button"] {
