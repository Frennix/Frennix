...
const frennixWebDocumentCss = `
  ...
  /* Inline feed video must not capture taps — dedicated hit layer opens the viewer. */
  video.feed-inline-video {
    pointer-events: none !important;
  }
  .feed-video-open-hit-layer {
    position: absolute !important;
    inset: 0 !important;
    z-index: 2 !important;
    touch-action: pan-y !important;
  ...
  [data-frennix-comments-fullscreen="true"] [data-frennix-comment-input="true"],
  [data-frennix-comments-fullscreen="true"] textarea,
  [data-frennix-comments-fullscreen="true"] input {
    background-color: ${FRENNIX_WEB_SURFACE} !important;
  }
  ...
  [data-frennix-comments-route="true"] [data-frennix-comment-input="true"],
  [data-frennix-comments-route="true"] textarea,
  [data-frennix-comments-route="true"] input {
    font-size: 16px !important;
    line-height: 22px !important;
    background-color: ${FRENNIX_WEB_SURFACE} !important;
    transform: none !important;
