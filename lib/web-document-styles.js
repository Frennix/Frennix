...
const frennixWebDocumentCss = `
  ...
  [data-frennix-reel-scrubber="true"][data-frennix-reel-scrub-locked="true"] {
    touch-action: none !important;
  }
  .frennix-immersive-video-playlist-scroll[data-frennix-reel-scrubbing="true"] {
  ...
  [data-frennix-immersive-comments-open="true"] video.fullscreen-video-slide,
  [data-frennix-immersive-comments-open="true"] video.feed-inline-video {
  ...
  [data-frennix-lightbox="true"][data-frennix-immersive-comments-open="true"],
  [data-frennix-lightbox-stage-shell="true"] {
    overflow: visible !important;
  }
  [data-frennix-video-stage-host="true"] {
    overflow: hidden !important;
  }
  ...
  .frennix-immersive-video-playlist-scroll > [data-frennix-video-playlist-page="preload"] {
  ...
  [data-frennix-comments-video-overlay="true"] [data-frennix-comments-list="true"] {
    position: relative !important;
    z-index: 1 !important;
    flex: 1 1 auto !important;
    min-height: 0 !important;
  ...
  [data-frennix-comments-state="empty"] {
  ...
  [data-frennix-comments-video-overlay="true"] [data-frennix-comment-composer-host="true"] img,
  [data-frennix-comments-video-overlay="true"] [data-frennix-comment-composer-host="true"] picture,
  [data-frennix-reel-comment-composer="true"] img,
  [data-frennix-reel-comment-composer="true"] picture {
    display: none !important;
    width: 0 !important;
    height: 0 !important;
  ...
  [data-frennix-reel-comment-composer="true"] [data-video-comment-field="true"] {
    display: flex !important;
    flex-direction: row !important;
    align-items: flex-end !important;
    flex: 1 1 auto !important;
  ...
  [data-frennix-reel-comment-composer="true"] textarea[data-frennix-comment-input="true"] {
    display: block !important;
    ...
    max-height: var(--comment-field-max-height, 156px) !important;
    background: transparent !important;
    background-color: transparent !important;
    color: #fff !important;
    color-scheme: dark !important;
  ...
  [data-frennix-reel-comment-composer="true"] [data-frennix-comment-send="true"] {
  ...
  /*
   * Reel composer must beat the shared 48px field pin. That pin plus overflow:hidden
   * and contain:paint makes iOS Safari report a 1–2 line scrollHeight.
   */
  [data-frennix-reel-comment-composer="true"] {
    height: auto !important;
    max-height: none !important;
  ...
  body[data-frennix-comments-open="true"] [data-frennix-comments-video-overlay="true"] {
    pointer-events: auto !important;
    isolation: isolate;
    z-index: 100001 !important;
    background: transparent !important;
